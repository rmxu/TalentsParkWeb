...
<script type='text/javascript'>
	...
	function download(skin_name){
		...
		diag.show();
		var setup_dir=document.getElementById('dir_value_'+skin_name).value;
		window.location.href='download_file.action.php?download_mod=skin&download_name='+skin_name+'&setup_dir='+setup_dir;
	}
...
<div id="maincontent">
    <div class="wrap">
<div class="crumbs"><?php echo $ad_langpackage->ad_location;?> &gt;&gt; <a href="javascript:void(0);"><?php echo $ad_langpackage->ad_ui_set;?></a> &gt;&gt; <a href="download_skin_list.php"><?php echo $ad_langpackage->ad_download_skin;?></a></div>
<hr />
<div class="infobox">
<h3><?php echo $u_langpackage->u_skins_list;?></h3>
<div class="content">
<?php if($is_show==1){?>
	...
	<?php
	foreach($skin_list as $rs){
	?>
		<tr>
			<td width="50%"><?php echo $rs;?></td>
			<td width="*">skin/<?php echo preg_replace('/\/\w*/',"",$skinUrl);?>/
			...
			<td width="15%">
				&nbsp|&nbsp
				<a href='javascript:download("<?php echo $rs;?>");' onclick='return confirm("<?php echo $u_langpackage->u_ask_skin;?>")'><?php echo $u_langpackage->u_download;?></a> &nbsp|&nbsp
				<a href='javascript:show_change("<?php echo $rs;?>");'><?php echo $u_langpackage->u_change_dir;?></a>&nbsp|
			</td>
		</tr>
	<?php }?>
	</table>
...
<table class="list_table">
    ...
    <tr>
        <td><?php echo $u_langpackage->u_skin_prompt_1;?></td>
    </tr>
    <tr>
        <td><?php echo $u_langpackage->u_skin_prompt_2;?></td>
    </tr>
</table>
</div>
</div>
