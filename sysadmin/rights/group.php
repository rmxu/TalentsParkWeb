...
if(get_args('action')){
	...
	if(!is_null(get_args('rights')))$sql="update $t_backgroup set rights='".implode(",",get_args('rights'))."' where gid='$gid'";
	$dbo->exeUpdate($sql);
...
<div id="maincontent">
    <div class="wrap">
        <div class="crumbs"><?php echo $ad_langpackage->ad_location;?> &gt;&gt; <a href="javascript:void(0);"><?php echo $ad_langpackage->ad_rights_manage;?></a> &gt;&gt; <a href="group.php?gid=<?php echo $gid;?>"><?php echo $ad_langpackage->ad_back_role_rights;?></a></div>
        <hr />
        <div class="infobox">
...
<form action="" method="post">
	<table class='list_table'>
		<tr><thead><th><?php echo $ri_langpackage->ri_local_user;?>：<?php echo $groups['name'];?></th></thead></tr>
<?php
$group_num=0;
