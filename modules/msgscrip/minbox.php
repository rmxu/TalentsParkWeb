...
<body id="iframecontent">
    ...
    <div class="tabs">
        <ul class="menu">
            <li class="active"><a href="javascript:void(0)" title="<?php echo $m_langpackage->m_in;?>" hidefocus="true"><?php echo $m_langpackage->m_in;?></a></li>
...
<?php foreach($msg_inbox_rs as $key => $val){?>
        <tr>
            ...
            <td width="135"><a target="_blank" href='home.php?h=<?php echo $val['from_user_id'];?>'><?php echo $val["from_user"];?></a>
            <br/><label class="gray"><?php echo $val["add_time"];?></label></td>
            <td><a title='<?php echo $val["mess_title"];?>' href='modules.php?app=msg_rpshow&id=<?php echo $val["mess_id"];?>&t=0'><?php echo $val["mess_title"];?></a></td>
