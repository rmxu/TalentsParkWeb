...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath : 'servtools/editor/nicEditorIcons.gif',
...
var nicEditorFontFamilySelect = nicEditorSelect.extend({
	sel : {'宋体' : '宋体','华文行楷' : '华文行楷','幼圆' : '幼圆','楷体_GB2312' : '楷体_GB2312','隶书' : '隶书','仿宋_GB2312' : '仿宋_GB2312','arial' : 'Arial','comic sans ms' : 'Comic Sans','courier new' : 'Courier New','georgia' : 'Georgia', 'helvetica' : 'Helvetica', 'impact' : 'Impact', 'times new roman' : 'Times', 'trebuchet ms' : 'Trebuchet', 'verdana' : 'Verdana'},
...
var nicEditorFontFormatSelect = nicEditorSelect.extend({
		sel : {'p' : 'p标签', 'pre' : 'Pre标签', 'h6' : '段落&nbsp;6', 'h5' : '段落&nbsp;5', 'h4' : '段落&nbsp;4', 'h3' : '段落&nbsp;3', 'h2' : '段落&nbsp;2', 'h1' : '段落&nbsp;1'},
...
var nicLinkButton = nicEditorAdvancedButton.extend({	
	addPane : function() {
		...
		this.addForm({
			'' : {type : 'title', txt : '添加/编辑 链接'},
			'href' : {type : 'text', txt : '地址：', value : 'http://', style : {width: '150px'}},
			'title' : {type : 'text', txt : '标题：'},
			'target' : {type : 'select', txt : '方式：', options : {'' : '当前窗口', '_blank' : '新窗口'},style : {width : '100px'}}
		},this.ln);
	},
...
var nicImageButton = nicEditorAdvancedButton.extend({	
	addPane : function() {
		...
		this.addForm({
			'' : {type : 'title', txt : '添加/编辑 图片'},
			'src' : {type : 'text', txt : '地址：', 'value' : 'http://', style : {width: '150px'}},
			'alt' : {type : 'text', txt : '提示：', style : {width: '100px'}},
			'align' : {type : 'select', txt : '对齐：', options : {none : '默认','left' : '居左', 'right' : '居右'}}
		},this.im);
	},
...
var nicUploadButton = nicEditorAdvancedButton.extend({	
	...
	addForm : function() {
		...
		myDoc.write('<div style="font-size: 14px; font-weight: bold; padding-top: 5px;">插入图片</div>');
