...
class arrayhomelp{
	...
	var $ah_personal_space_detail = "<dd>建立自己的空间，发表课程、照片，分</dd><dd>享生活中的点点滴滴..</dd>";
	...
	var $ah_latest_blog = "最新课程";
	var $ah_see_all_my_log = "查看我的全部课程";
	var $ah_all_logs = "全部课程";
	...
	var $ah_after_friend = "成为好友后，您们就可以一起讨论话题，及时关注对方的更新，还可以玩有趣的游戏 ... <br />您也可以方便快捷地发布自己的课程、上传图片、记录生活点滴与好友分享。 <br />还等什么呢？赶快加入我们吧。";
	var $ah_times = "次";
